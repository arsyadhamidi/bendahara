...
@section('title', 'Data Bendahara | SISKEU')
        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('data-bendahara.create') }}" class="btn btn-primary">
                        <i class="bx bx-plus"></i>
                        Tambahkan Data Bendahara
                    </a>
                </div>
                        ...
                        <tbody>
                            @foreach ($bendaharas as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->telp ?? '-' }}</td>
                                    <td>
                                        <form action="{{ route('data-bendahara.destroy', $data->id) }}" method="POST"
                                            class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('data-bendahara.edit', $data->id) }}"
