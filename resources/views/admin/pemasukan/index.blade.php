        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('data-pemasukan.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($pemasukans as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->masukan ?? '-' }}</td>
                                    <td>{{ $data->tgl_masukan ?? '-' }}</td>
                                    <td>Rp. {{ $data->jumlah ?? '-' }}, -</td>
                                    <td>{{ $data->keterangan ?? '-' }}</td>
                                    <td>
                                        <form action="{{ route('data-pemasukan.destroy', $data->id) }}" method="POST"
                                            class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('data-pemasukan.edit', $data->id) }}"
