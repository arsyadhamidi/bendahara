...
@section('content')
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('data-pemasukan.store') }}" method="POST">
                @csrf
                <div class="card">
                            ...
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="masukan"
                                        ...
                                        value="{{ old('masukan') }}" placeholder="Masukan nama pemasukan">
                                    @error('masukan')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="tgl_masukan"
                                        ...
                                        value="{{ old('tgl_masukan', \Carbon\Carbon::now()->format('Y-m-d')) }}">
                                    @error('tgl_masukan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="jumlah"
                                        ...
                                        value="{{ old('jumlah') }}" placeholder="Masukan jumlah pemasukan">
                                    @error('jumlah')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
